...
class ImagePipelineConfigUtils {
    companion object {
        // 最大可用内存
        private val maxHeapSize: Long = Runtime.getRuntime().maxMemory()
        // 缓存Disk小图片文件夹名称
        private val smallDiskCacheName: String = "smallDiskCacheConfig"
        // 缓存Disk普通图片文件夹名称
        private val normalDiskCacheName: String = "normalDiskCacheConfig"
        // 缓存Disk文件夹大小
        private val diskCacheSize: Int = 100 * ByteConstants.MB
        // 低硬盘空间下缓存Disk文件夹大小
        private val lowDiskCacheSize: Int = 50 * ByteConstants.MB
        // 非常低硬盘空间下缓存Disk文件夹大小
        private val veryLowDiskCacheSize: Int = 20 * ByteConstants.MB

        @JvmStatic
        fun getDefaultImagePipelineConfig(context: Context, okHttpClient: OkHttpClient): ImagePipelineConfig {
...
//            OkHttpImagePipelineConfigFactory.newBuilder(context, OkHttpClient())
            val imagePipelineConfig: ImagePipelineConfig.Builder = OkHttpImagePipelineConfigFactory.newBuilder(context, okHttpClient)
